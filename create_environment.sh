...
Acsa,Shell Navigation, submitted
Bruce, Shell Navigation, not submitted
Gaby, Shell Navigation, submitted
Exode, Shell Navigation, not submitted
Merle, Shell Navigation, not submitted
EOF
...
echo "NOW YOU CAN CHECK ./startup.sh AND SEE"
